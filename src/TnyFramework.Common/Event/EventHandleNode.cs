...
namespace TnyFramework.Common.Event
{
    ...
    {
        private static readonly AnyPool<EventHandleNode<TTarget, THandle>> OBJECT_POOL =
            new DefaultPool<EventHandleNode<TTarget, THandle>>(new DefaultPooledPolicy<EventHandleNode<TTarget, THandle>>());
