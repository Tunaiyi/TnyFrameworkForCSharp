...
namespace TnyFramework.Common.Event.Notices
{
    ...
    public abstract class ListenInvokerEvent<TListener, TParam, TEvent> : ListenBaseEvent<TListener, TListener, TParam, TEvent>
        where TEvent : ListenInvokerEvent<TListener, TParam, TEvent>
    {
        private Action<TListener, TParam> invoker;
        ...
        protected ListenInvokerEvent(Action<TListener, TParam> invoker)
    {
        ...
        protected ListenInvokerEvent(TEvent parent) : base(parent)
    {
    ...
    public abstract class ListenActionEvent<TListener, THandler, TParam, TEvent> : ListenBaseEvent<TListener, THandler, TParam, TEvent>
        where TEvent : ListenActionEvent<TListener, THandler, TParam, TEvent>
    {
        private Func<TListener, THandler> handleFactory;
        ...
        protected ListenActionEvent(Func<TListener, THandler> invoker)
    {
        ...
        protected ListenActionEvent(TEvent parent) : base(parent)
    {
        handleFactory = parent.handleFactory;
    }
    ...
    public abstract class ListenBaseEvent<TListener, THandle, TParam, TEvent> : BaseEvent<TListener, THandle, TEvent>
        where TEvent : ListenBaseEvent<TListener, THandle, TParam, TEvent>
    {
