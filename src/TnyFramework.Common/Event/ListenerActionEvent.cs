...
namespace TnyFramework.Common.Event
{
    ...
    public class ListenerActionEvent<TListener, TSource>
        : ListenActionEvent<TListener, Action<TSource>, TSource, IListenEvent<TListener, TSource>>,
            IListenEvent<TListener, TSource>
    {
        ...
        private ListenerActionEvent(IListenEvent<TListener, TSource> parent, Func<TListener, Action<TSource>> invoker)
            : base(parent, invoker)
        {
        }
        ...
        {
            return new ListenerActionEvent<TListener, TSource>(this, handleFactory);
        }
    }
    ...
    public class ListenerActionEvent<TListener, TSource, TArg1>
        : ListenActionEvent<TListener, Action<TSource, TArg1>, (TSource, TArg1), IListenEvent<TListener, TSource, TArg1>>,
            IListenEvent<TListener, TSource, TArg1>
    {
        ...
        private ListenerActionEvent(IListenEvent<TListener, TSource, TArg1> parent, Func<TListener, Action<TSource, TArg1>> invoker)
            : base(parent, invoker)
        {
        }
        ...
        {
            return new ListenerActionEvent<TListener, TSource, TArg1>(this, handleFactory);
        }
    }
    ...
    public class ListenerActionEvent<TListener, TSource, TArg1, TArg2>
        : ListenActionEvent<TListener, Action<TSource, TArg1, TArg2>, (TSource, TArg1, TArg2), IListenEvent<TListener, TSource, TArg1, TArg2>>,
            IListenEvent<TListener, TSource, TArg1, TArg2>
    {
        ...
        private ListenerActionEvent(IListenEvent<TListener, TSource, TArg1, TArg2> parent, Func<TListener, Action<TSource, TArg1, TArg2>> invoker)
            : base(parent, invoker)
        {
        }
        ...
        {
            return new ListenerActionEvent<TListener, TSource, TArg1, TArg2>(this, handleFactory);
        }
    }
            ...
            IListenEvent<TListener, TSource, TArg1, TArg2, TArg3>
    {
        ...
        private ListenerActionEvent(IListenEvent<TListener, TSource, TArg1, TArg2, TArg3> parent,
            Func<TListener, Action<TSource, TArg1, TArg2, TArg3>> invoker)
            : base(parent, invoker)
        {
        }
        ...
        {
            return new ListenerActionEvent<TListener, TSource, TArg1, TArg2, TArg3>(this, handleFactory);
        }
    }
            ...
            IListenEvent<TListener, TSource, TArg1, TArg2, TArg3, TArg4>
    {
        ...
        public ListenerActionEvent(IListenEvent<TListener, TSource, TArg1, TArg2, TArg3, TArg4> parent,
            Func<TListener, Action<TSource, TArg1, TArg2, TArg3, TArg4>> invoker) : base(parent, invoker)
        {
        }
        ...
        {
            return new ListenerActionEvent<TListener, TSource, TArg1, TArg2, TArg3, TArg4>(this, handleFactory);
        }
    }
            ...
            IListenEvent<TListener, TSource, TArg1, TArg2, TArg3, TArg4, TArg5>
    {
        ...
        public ListenerActionEvent(IListenEvent<TListener, TSource, TArg1, TArg2, TArg3, TArg4, TArg5> parent,
            Func<TListener, Action<TSource, TArg1, TArg2, TArg3, TArg4, TArg5>> invoker) : base(parent, invoker)
        {
        }
        ...
        protected override void OnNotify(Action<TSource, TArg1, TArg2, TArg3, TArg4, TArg5> handle,
            (TSource, TArg1, TArg2, TArg3, TArg4, TArg5) param)
        {
        ...
        {
            return new ListenerActionEvent<TListener, TSource, TArg1, TArg2, TArg3, TArg4, TArg5>(this, handleFactory);
        }
    }
            ...
            IListenEvent<TListener, TSource, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>
    {
        ...
        public ListenerActionEvent(IListenEvent<TListener, TSource, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6> parent,
            Func<TListener, Action<TSource, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>> invoker) : base(parent, invoker)
        {
        }
        ...
        {
            return new ListenerActionEvent<TListener, TSource, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6>(this, handleFactory);
        }
    }
