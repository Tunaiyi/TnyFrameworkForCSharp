...
namespace TnyFramework.Net.DotNetty.Configuration.Guide
{
    ...
    public interface INettyServerGuideSpec : INettyGuideSpec<INetServerGuide, INettyServerGuideUnitContext, INettyServerGuideSpec>
    {
        INettyServerGuideSpec Server(IServerSetting setting);
