...
namespace TnyFramework.Net.DotNetty.Configuration.Guide
{
    ...
    public class NettyServerGuideUnitContext : NettyGuideUnitContext<INettyServerGuideUnitContext>, INettyServerGuideUnitContext
    {
        ...
        private UnitSpec<INetworkContext, INettyServerGuideUnitContext> NetworkContextSpec { get; }
        ...
        public NettyServerGuideUnitContext(INetUnitContext unitContext, IServiceCollection unitContainer) : base(unitContext, unitContainer)
        {
            ...
            NetworkContextSpec = UnitSpec.Unit<INetworkContext, INettyServerGuideUnitContext>()
        ...
        private static INetworkContext DefaultNetworkContext(INettyServerGuideUnitContext context)
        {
