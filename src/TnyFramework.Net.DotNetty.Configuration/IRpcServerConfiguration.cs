...
namespace TnyFramework.Net.DotNetty.Configuration
{
    ...
    {
        RpcServerConfiguration RpcServer(ServerSetting setting, Action<INetServerGuideSpec>? action = null);

        RpcServerConfiguration RpcServer(string name, int port, Action<INetServerGuideSpec>? action = null);

        RpcServerConfiguration RpcServer(string name, string host, int port, Action<INetServerGuideSpec>? action = null);
