...
public interface ISessionKeeperSettingSpec : IUnitSpec<ISessionKeeperSetting, ISessionUnitContext>
{
...
public class SessionKeeperSettingSpec : UnitSpec<ISessionKeeperSetting, ISessionUnitContext>, ISessionKeeperSettingSpec
{
