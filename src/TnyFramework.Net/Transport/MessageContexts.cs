...
namespace TnyFramework.Net.Transport
{
    ...
    public static class MessageContexts
    {
        ...
        /// <returns>创建的消息上下文</returns>
        public static RequestContext Request(IProtocol protocol, params object[] requestParams)
        {
            return new DefaultMessageContext(MessageMode.Request, protocol, ResultCode.SUCCESS)
