...
public abstract class CompletableRpcMessageTransactionContext : RpcMessageTransactionContext
{
    ...
    public CompletableRpcMessageTransactionContext(INetMessage message, bool async, IAttributes? attributes = null)
