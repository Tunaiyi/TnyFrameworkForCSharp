...
namespace TnyFramework.Net.Endpoint
{
    ...
    {
        IEndpointKeeper CreateKeeper(IContactType contactType, IEndpointKeeperSetting setting);
    }
    ...
    {
        TEndpointKeeper CreateKeeper(IContactType contactType, TSetting setting);
    }
