...
namespace TnyFramework.Net.Common
{
    ...
    public class NetResultCode : ResultCode<NetResultCode>
    {
        ...
        /// 无处理
        /// </summary>
        public static readonly IResultCode EMPTY = Of(0, "无处理");

        /// <summary>
        /// 服务端返回响应编码响应异常(不断开连接)
        /// </summary>
        public static readonly IResultCode DECODE_FAILED = Of(151, "编码响应异常", ResultLevel.Warn);

        /// <summary>
        /// 服务端返回响应编码响应异常
        /// </summary>
        public static readonly IResultCode ENCODE_FAILED = Of(152, "编码响应异常", ResultLevel.Warn);

        /// <summary>
        /// 服务端接受请求解码格式错误(断开连接)
        /// </summary>
        public static readonly IResultCode DECODE_ERROR = Of(153, "解码格式错误", ResultLevel.Error);

        /// <summary>
        /// 服务端返回响应编码响应异常
        /// </summary>
        public static readonly IResultCode ENCODE_ERROR = Of(154, "编码响应错误", ResultLevel.Error);

        /// <summary>
        /// 收到的网络包超时失效
        /// </summary>
        public static readonly IResultCode PACKET_TIMEOUT = Of(155, "网络包超时失效", ResultLevel.Warn);

        /// <summary>
        /// 网络包校验失败
        /// </summary>
        public static readonly IResultCode PACKET_VERIFY_FAILED = Of(156, "网络包校验失败", ResultLevel.Warn);

        /// <summary>
        /// 拒绝接受消息
        /// </summary>
        public static readonly IResultCode REJECT_TO_RECEIVE_MESSAGE = Of(180, "拒绝接受消息", ResultLevel.Warn);

        /// <summary>
        /// 拒绝发送消息
        /// </summary>
        public static readonly IResultCode REJECT_TO_SEND_MESSAGE = Of(181, "拒绝发送消息", ResultLevel.Warn);

        /// <summary>
        /// 消息发送失败
        /// </summary>
        public static readonly IResultCode MESSAGE_SEND_FAILED = Of(182, "消息发送失败", ResultLevel.Warn);

        /// <summary>
        /// 连接断开
        /// </summary>
        public static readonly IResultCode DISCONNECTION = Of(183, "连接断开", ResultLevel.Warn);
        ...
        /// 验证失败
        /// </summary>
        public static readonly IResultCode AUTH_FAIL_ERROR = Of(210, "验证失败", ResultLevel.Error);
        ...
        /// 服务不可用
        /// </summary>
        public static readonly IResultCode RPC_SERVICE_NOT_AVAILABLE = Of(400, "服务不可用", ResultLevel.Warn);
